...
- [x] **F1-7 · Sync live (BackgroundService)** _(lógica + test mock; wiring de recurrencia real con key)_
...
- **ESTADO GLOBAL FINAL:** ✅ **Fases 0, 1(sin key), 2, 3, 4 COMPLETAS y verificadas.** Fase 5 = configs de deploy listas (`deploy/`), ejecución requiere VPS. **14 unit tests verdes; back+front build verde (front requiere API up para prerender de páginas de datos).**
